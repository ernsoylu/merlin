...
run nvm "$ROOT/v01-reference/components/NvM/src/nvm.c" "$ROOT/test/host/test_nvm.c"
...
run mcal_mcu "$ROOT/v01-reference/components/Mcal_Mcu/src/mcal_mcu.c" "$ROOT/test/host/test_mcal_mcu.c"
