...
#if defined(CONFIG_ESP_PHY_INIT_DATA_VDD33_CONST) && \
    CONFIG_ESP_PHY_INIT_DATA_VDD33_CONST != 255
    if (config->mode == MCAL_ADC_VDD) {
        /* The SDK only permits VDD reads when PHY calibration is set to 0xff. */
